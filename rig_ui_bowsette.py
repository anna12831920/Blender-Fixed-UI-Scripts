...
class RigUI(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if is_selected({'upper_arm_fk.L', 'forearm_tweak.L', 'hand_tweak.L', 'upper_arm_tweak.L', 'forearm_tweak.L.001', 'VIS_upper_arm_ik_pole.L', 'upper_arm_ik.L', 'upper_arm_ik_target.L', 'upper_arm_parent.L', 'upper_arm_tweak.L.001', 'hand_ik.L', 'hand_fk.L', 'forearm_fk.L'}):
            emit_rig_separator()
            if is_selected({'upper_arm_fk.L', 'upper_arm_parent.L', 'forearm_fk.L', 'hand_fk.L'}):
            ...
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='FK->IK (hand.L)', icon='SNAP_ON')
            ...
            props = group2.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='Action', icon='ACTION_TWEAK')
            props.output_bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            props.input_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
            props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
            props = group2.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='Clear', icon='CANCEL')
            props.bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_wiuwxucx1587dd46', text='IK->FK (hand.L)', icon='SNAP_ON')
            ...
            props.extra_ctrls = '[]'
            group2 = group1.row(align=True)
            props = group2.operator('pose.rigify_limb_ik2fk_bake_wiuwxucx1587dd46', text='Action', icon='ACTION_TWEAK')
            props.prop_bone = 'upper_arm_parent.L'
            props.fk_bones = '["upper_arm_fk.L", "forearm_fk.L", "hand_fk.L"]'
            props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
            props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
            ...
            if is_selected({'upper_arm_ik_target.L', 'upper_arm_parent.L', 'hand_ik.L', 'upper_arm_ik.L'}):
                ...
                props = group2.operator('pose.rigify_limb_toggle_pole_wiuwxucx1587dd46', icon='FORCE_MAGNETIC')
                props.prop_bone = 'upper_arm_parent.L'
                props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
                props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
                props.extra_ctrls = '[]'
                group2.prop(pose_bones['upper_arm_parent.L'], '["pole_vector"]', text='')
                props = group1.operator('pose.rigify_limb_toggle_pole_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.prop_bone = 'upper_arm_parent.L'
                props.ik_bones = '["upper_arm_ik.L", "MCH-forearm_ik.L", "MCH-upper_arm_ik_target.L"]'
                props.ctrl_bones = '["upper_arm_ik.L", "upper_arm_ik_target.L", "hand_ik.L"]'
                props.extra_ctrls = '[]'
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                ...
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'hand_ik.L'
                props.prop_bone = 'upper_arm_parent.L'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "Root", "Torso", "Hips", "Chest", "Head", "shoulder.L"]'
                ...
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='Pole Parent', icon='DOWNARROW_HLT')
        ...
        if is_selected({'f_index.01.L.001', 'f_index.01.L', 'f_index.02.L', 'f_index.01_master.L', 'f_index.03.L', 'f_index.01_ik.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_index.01_ik.L'], '["FK_IK"]', text='Finger IK (f_index.01.L)', slider=True)
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_finger_fk2ik_wiuwxucx1587dd46', text='FK->IK (f_index.01.L)', icon='SNAP_ON')
            props.fk_master = 'f_index.01_master.L'
            props.fk_chain = '["f_index.01.L", "f_index.02.L", "f_index.03.L", "f_index.01.L.001"]'
            props.ik_chain = '["ORG-f_index.01.L", "ORG-f_index.02.L", "ORG-f_index.03.L"]'
            props.ik_control = 'f_index.01_ik.L'
            props.constraint_bone = 'ORG-f_index.03.L'
            props.axis = '+X'
            props = group1.operator('pose.rigify_finger_fk2ik_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.fk_master = 'f_index.01_master.L'
            props.fk_chain = '["f_index.01.L", "f_index.02.L", "f_index.03.L", "f_index.01.L.001"]'
            props.ik_chain = '["ORG-f_index.01.L", "ORG-f_index.02.L", "ORG-f_index.03.L"]'
            props.ik_control = 'f_index.01_ik.L'
            props.constraint_bone = 'ORG-f_index.03.L'
            props.axis = '+X'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_index.01_master.L", "f_index.01.L", "f_index.02.L", "f_index.03.L", "f_index.01.L.001"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='IK->FK (f_index.01.L)', icon='SNAP_ON')
            props.output_bones = '["f_index.01_ik.L"]'
            props.input_bones = '["f_index.01.L.001"]'
            props.ctrl_bones = '["f_index.01_master.L", "f_index.01.L", "f_index.02.L", "f_index.03.L", "f_index.01.L.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.output_bones = '["f_index.01_ik.L"]'
            props.input_bones = '["f_index.01.L.001"]'
            props.ctrl_bones = '["f_index.01_master.L", "f_index.01.L", "f_index.02.L", "f_index.03.L", "f_index.01.L.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_index.01_ik.L"]'
            layout.prop(pose_bones['f_index.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)
            if is_selected({'f_index.01_ik.L'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'f_index.01_ik.L'
                props.prop_bone = 'f_index.01_ik.L'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "hand_ik.L"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['f_index.01_ik.L'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'f_index.01_ik.L'
                props.prop_bone = 'f_index.01_ik.L'
                props.prop_id = 'IK_parent'
        ...
        if is_selected({'thumb.01_ik.L', 'thumb.02.L', 'thumb.01.L.001', 'thumb.01.L', 'thumb.03.L', 'thumb.01_master.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['thumb.01_ik.L'], '["FK_IK"]', text='Finger IK (thumb.01.L)', slider=True)
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_finger_fk2ik_wiuwxucx1587dd46', text='FK->IK (thumb.01.L)', icon='SNAP_ON')
            props.fk_master = 'thumb.01_master.L'
            props.fk_chain = '["thumb.01.L", "thumb.02.L", "thumb.03.L", "thumb.01.L.001"]'
            props.ik_chain = '["ORG-thumb.01.L", "ORG-thumb.02.L", "ORG-thumb.03.L"]'
            props.ik_control = 'thumb.01_ik.L'
            props.constraint_bone = 'ORG-thumb.03.L'
            props.axis = '+X'
            props = group1.operator('pose.rigify_finger_fk2ik_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.fk_master = 'thumb.01_master.L'
            props.fk_chain = '["thumb.01.L", "thumb.02.L", "thumb.03.L", "thumb.01.L.001"]'
            ...
            props.axis = '+X'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["thumb.01_master.L", "thumb.01.L", "thumb.02.L", "thumb.03.L", "thumb.01.L.001"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='IK->FK (thumb.01.L)', icon='SNAP_ON')
            props.output_bones = '["thumb.01_ik.L"]'
            props.input_bones = '["thumb.01.L.001"]'
            props.ctrl_bones = '["thumb.01_master.L", "thumb.01.L", "thumb.02.L", "thumb.03.L", "thumb.01.L.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.output_bones = '["thumb.01_ik.L"]'
            ...
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["thumb.01_ik.L"]'
            layout.prop(pose_bones['thumb.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)
            if is_selected({'thumb.01_ik.L'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'thumb.01_ik.L'
                props.prop_bone = 'thumb.01_ik.L'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "hand_ik.L"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['thumb.01_ik.L'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'thumb.01_ik.L'
                props.prop_bone = 'thumb.01_ik.L'
                props.prop_id = 'IK_parent'
        ...
        if is_selected({'f_middle.02.L', 'f_middle.01.L.001', 'f_middle.01_master.L', 'f_middle.01_ik.L', 'f_middle.01.L', 'f_middle.03.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_middle.01_ik.L'], '["FK_IK"]', text='Finger IK (f_middle.01.L)', slider=True)
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_finger_fk2ik_wiuwxucx1587dd46', text='FK->IK (f_middle.01.L)', icon='SNAP_ON')
            props.fk_master = 'f_middle.01_master.L'
            props.fk_chain = '["f_middle.01.L", "f_middle.02.L", "f_middle.03.L", "f_middle.01.L.001"]'
            props.ik_chain = '["ORG-f_middle.01.L", "ORG-f_middle.02.L", "ORG-f_middle.03.L"]'
            props.ik_control = 'f_middle.01_ik.L'
            props.constraint_bone = 'ORG-f_middle.03.L'
            props.axis = '+X'
            props = group1.operator('pose.rigify_finger_fk2ik_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.fk_master = 'f_middle.01_master.L'
            props.fk_chain = '["f_middle.01.L", "f_middle.02.L", "f_middle.03.L", "f_middle.01.L.001"]'
            ...
            props.axis = '+X'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_middle.01_master.L", "f_middle.01.L", "f_middle.02.L", "f_middle.03.L", "f_middle.01.L.001"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='IK->FK (f_middle.01.L)', icon='SNAP_ON')
            props.output_bones = '["f_middle.01_ik.L"]'
            props.input_bones = '["f_middle.01.L.001"]'
            props.ctrl_bones = '["f_middle.01_master.L", "f_middle.01.L", "f_middle.02.L", "f_middle.03.L", "f_middle.01.L.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.output_bones = '["f_middle.01_ik.L"]'
            ...
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_middle.01_ik.L"]'
            layout.prop(pose_bones['f_middle.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)
            if is_selected({'f_middle.01_ik.L'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'f_middle.01_ik.L'
                props.prop_bone = 'f_middle.01_ik.L'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "hand_ik.L"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['f_middle.01_ik.L'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'f_middle.01_ik.L'
                props.prop_bone = 'f_middle.01_ik.L'
                props.prop_id = 'IK_parent'
        ...
        if is_selected({'f_ring.01.L.001', 'f_ring.01_ik.L', 'f_ring.01.L', 'f_ring.02.L', 'f_ring.01_master.L', 'f_ring.03.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_ring.01_ik.L'], '["FK_IK"]', text='Finger IK (f_ring.01.L)', slider=True)
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_finger_fk2ik_wiuwxucx1587dd46', text='FK->IK (f_ring.01.L)', icon='SNAP_ON')
            props.fk_master = 'f_ring.01_master.L'
            props.fk_chain = '["f_ring.01.L", "f_ring.02.L", "f_ring.03.L", "f_ring.01.L.001"]'
            props.ik_chain = '["ORG-f_ring.01.L", "ORG-f_ring.02.L", "ORG-f_ring.03.L"]'
            props.ik_control = 'f_ring.01_ik.L'
            props.constraint_bone = 'ORG-f_ring.03.L'
            props.axis = '+X'
            props = group1.operator('pose.rigify_finger_fk2ik_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.fk_master = 'f_ring.01_master.L'
            props.fk_chain = '["f_ring.01.L", "f_ring.02.L", "f_ring.03.L", "f_ring.01.L.001"]'
            ...
            props.axis = '+X'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_ring.01_master.L", "f_ring.01.L", "f_ring.02.L", "f_ring.03.L", "f_ring.01.L.001"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='IK->FK (f_ring.01.L)', icon='SNAP_ON')
            props.output_bones = '["f_ring.01_ik.L"]'
            props.input_bones = '["f_ring.01.L.001"]'
            props.ctrl_bones = '["f_ring.01_master.L", "f_ring.01.L", "f_ring.02.L", "f_ring.03.L", "f_ring.01.L.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.output_bones = '["f_ring.01_ik.L"]'
            ...
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_ring.01_ik.L"]'
            layout.prop(pose_bones['f_ring.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)
            if is_selected({'f_ring.01_ik.L'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'f_ring.01_ik.L'
                props.prop_bone = 'f_ring.01_ik.L'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "hand_ik.L"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['f_ring.01_ik.L'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'f_ring.01_ik.L'
                props.prop_bone = 'f_ring.01_ik.L'
                props.prop_id = 'IK_parent'
        ...
        if is_selected({'f_pinky.02.L', 'f_pinky.01.L.001', 'f_pinky.03.L', 'f_pinky.01_master.L', 'f_pinky.01_ik.L', 'f_pinky.01.L'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_pinky.01_ik.L'], '["FK_IK"]', text='Finger IK (f_pinky.01.L)', slider=True)
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_finger_fk2ik_wiuwxucx1587dd46', text='FK->IK (f_pinky.01.L)', icon='SNAP_ON')
            props.fk_master = 'f_pinky.01_master.L'
            props.fk_chain = '["f_pinky.01.L", "f_pinky.02.L", "f_pinky.03.L", "f_pinky.01.L.001"]'
            props.ik_chain = '["ORG-f_pinky.01.L", "ORG-f_pinky.02.L", "ORG-f_pinky.03.L"]'
            props.ik_control = 'f_pinky.01_ik.L'
            props.constraint_bone = 'ORG-f_pinky.03.L'
            props.axis = '+X'
            props = group1.operator('pose.rigify_finger_fk2ik_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.fk_master = 'f_pinky.01_master.L'
            props.fk_chain = '["f_pinky.01.L", "f_pinky.02.L", "f_pinky.03.L", "f_pinky.01.L.001"]'
            ...
            props.axis = '+X'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_pinky.01_master.L", "f_pinky.01.L", "f_pinky.02.L", "f_pinky.03.L", "f_pinky.01.L.001"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='IK->FK (f_pinky.01.L)', icon='SNAP_ON')
            props.output_bones = '["f_pinky.01_ik.L"]'
            props.input_bones = '["f_pinky.01.L.001"]'
            props.ctrl_bones = '["f_pinky.01_master.L", "f_pinky.01.L", "f_pinky.02.L", "f_pinky.03.L", "f_pinky.01.L.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.output_bones = '["f_pinky.01_ik.L"]'
            ...
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_pinky.01_ik.L"]'
            layout.prop(pose_bones['f_pinky.01_master.L'], '["finger_curve"]', text='Curvature', slider=True)
            if is_selected({'f_pinky.01_ik.L'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'f_pinky.01_ik.L'
                props.prop_bone = 'f_pinky.01_ik.L'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "hand_ik.L"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['f_pinky.01_ik.L'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'f_pinky.01_ik.L'
                props.prop_bone = 'f_pinky.01_ik.L'
                props.prop_id = 'IK_parent'
        ...
        if is_selected({'forearm_tweak.R', 'hand_fk.R', 'VIS_upper_arm_ik_pole.R', 'upper_arm_ik.R', 'upper_arm_ik_target.R', 'upper_arm_tweak.R.001', 'upper_arm_tweak.R', 'hand_ik.R', 'forearm_fk.R', 'forearm_tweak.R.001', 'upper_arm_fk.R', 'upper_arm_parent.R', 'hand_tweak.R'}):
            emit_rig_separator()
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='FK->IK (hand.R)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_wiuwxucx1587dd46', text='IK->FK (hand.R)', icon='SNAP_ON')
            ...
            if is_selected({'hand_ik.R', 'upper_arm_parent.R', 'upper_arm_ik.R', 'upper_arm_ik_target.R'}):
        ...
        if is_selected({'f_index.01.R', 'f_index.01.R.001', 'f_index.02.R', 'f_index.03.R', 'f_index.01_ik.R', 'f_index.01_master.R'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_index.01_ik.R'], '["FK_IK"]', text='Finger IK (f_index.01.R)', slider=True)
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_finger_fk2ik_wiuwxucx1587dd46', text='FK->IK (f_index.01.R)', icon='SNAP_ON')
            props.fk_master = 'f_index.01_master.R'
            props.fk_chain = '["f_index.01.R", "f_index.02.R", "f_index.03.R", "f_index.01.R.001"]'
            props.ik_chain = '["ORG-f_index.01.R", "ORG-f_index.02.R", "ORG-f_index.03.R"]'
            props.ik_control = 'f_index.01_ik.R'
            props.constraint_bone = 'ORG-f_index.03.R'
            props.axis = '+X'
            props = group1.operator('pose.rigify_finger_fk2ik_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.fk_master = 'f_index.01_master.R'
            props.fk_chain = '["f_index.01.R", "f_index.02.R", "f_index.03.R", "f_index.01.R.001"]'
            ...
            props.axis = '+X'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_index.01_master.R", "f_index.01.R", "f_index.02.R", "f_index.03.R", "f_index.01.R.001"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='IK->FK (f_index.01.R)', icon='SNAP_ON')
            props.output_bones = '["f_index.01_ik.R"]'
            props.input_bones = '["f_index.01.R.001"]'
            props.ctrl_bones = '["f_index.01_master.R", "f_index.01.R", "f_index.02.R", "f_index.03.R", "f_index.01.R.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.output_bones = '["f_index.01_ik.R"]'
            ...
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_index.01_ik.R"]'
            layout.prop(pose_bones['f_index.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)
            if is_selected({'f_index.01_ik.R'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'f_index.01_ik.R'
                props.prop_bone = 'f_index.01_ik.R'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "hand_ik.R"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['f_index.01_ik.R'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'f_index.01_ik.R'
                props.prop_bone = 'f_index.01_ik.R'
                props.prop_id = 'IK_parent'
        ...
        if is_selected({'thumb.02.R', 'thumb.03.R', 'thumb.01.R', 'thumb.01_master.R', 'thumb.01.R.001', 'thumb.01_ik.R'}):
            emit_rig_separator()
            layout.prop(pose_bones['thumb.01_ik.R'], '["FK_IK"]', text='Finger IK (thumb.01.R)', slider=True)
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_finger_fk2ik_wiuwxucx1587dd46', text='FK->IK (thumb.01.R)', icon='SNAP_ON')
            props.fk_master = 'thumb.01_master.R'
            props.fk_chain = '["thumb.01.R", "thumb.02.R", "thumb.03.R", "thumb.01.R.001"]'
            props.ik_chain = '["ORG-thumb.01.R", "ORG-thumb.02.R", "ORG-thumb.03.R"]'
            props.ik_control = 'thumb.01_ik.R'
            props.constraint_bone = 'ORG-thumb.03.R'
            props.axis = '+X'
            props = group1.operator('pose.rigify_finger_fk2ik_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.fk_master = 'thumb.01_master.R'
            props.fk_chain = '["thumb.01.R", "thumb.02.R", "thumb.03.R", "thumb.01.R.001"]'
            ...
            props.axis = '+X'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["thumb.01_master.R", "thumb.01.R", "thumb.02.R", "thumb.03.R", "thumb.01.R.001"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='IK->FK (thumb.01.R)', icon='SNAP_ON')
            props.output_bones = '["thumb.01_ik.R"]'
            props.input_bones = '["thumb.01.R.001"]'
            props.ctrl_bones = '["thumb.01_master.R", "thumb.01.R", "thumb.02.R", "thumb.03.R", "thumb.01.R.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.output_bones = '["thumb.01_ik.R"]'
            ...
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["thumb.01_ik.R"]'
            layout.prop(pose_bones['thumb.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)
            if is_selected({'thumb.01_ik.R'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'thumb.01_ik.R'
                props.prop_bone = 'thumb.01_ik.R'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "hand_ik.R"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['thumb.01_ik.R'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'thumb.01_ik.R'
                props.prop_bone = 'thumb.01_ik.R'
                props.prop_id = 'IK_parent'
        ...
        if is_selected({'f_middle.03.R', 'f_middle.01_master.R', 'f_middle.02.R', 'f_middle.01.R', 'f_middle.01_ik.R', 'f_middle.01.R.001'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_middle.01_ik.R'], '["FK_IK"]', text='Finger IK (f_middle.01.R)', slider=True)
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_finger_fk2ik_wiuwxucx1587dd46', text='FK->IK (f_middle.01.R)', icon='SNAP_ON')
            props.fk_master = 'f_middle.01_master.R'
            props.fk_chain = '["f_middle.01.R", "f_middle.02.R", "f_middle.03.R", "f_middle.01.R.001"]'
            props.ik_chain = '["ORG-f_middle.01.R", "ORG-f_middle.02.R", "ORG-f_middle.03.R"]'
            props.ik_control = 'f_middle.01_ik.R'
            props.constraint_bone = 'ORG-f_middle.03.R'
            props.axis = '+X'
            props = group1.operator('pose.rigify_finger_fk2ik_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.fk_master = 'f_middle.01_master.R'
            props.fk_chain = '["f_middle.01.R", "f_middle.02.R", "f_middle.03.R", "f_middle.01.R.001"]'
            ...
            props.axis = '+X'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_middle.01_master.R", "f_middle.01.R", "f_middle.02.R", "f_middle.03.R", "f_middle.01.R.001"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='IK->FK (f_middle.01.R)', icon='SNAP_ON')
            props.output_bones = '["f_middle.01_ik.R"]'
            props.input_bones = '["f_middle.01.R.001"]'
            props.ctrl_bones = '["f_middle.01_master.R", "f_middle.01.R", "f_middle.02.R", "f_middle.03.R", "f_middle.01.R.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.output_bones = '["f_middle.01_ik.R"]'
            ...
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_middle.01_ik.R"]'
            layout.prop(pose_bones['f_middle.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)
            if is_selected({'f_middle.01_ik.R'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'f_middle.01_ik.R'
                props.prop_bone = 'f_middle.01_ik.R'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "hand_ik.R"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['f_middle.01_ik.R'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'f_middle.01_ik.R'
                props.prop_bone = 'f_middle.01_ik.R'
                props.prop_id = 'IK_parent'
        ...
        if is_selected({'f_ring.01_ik.R', 'f_ring.03.R', 'f_ring.02.R', 'f_ring.01.R', 'f_ring.01_master.R', 'f_ring.01.R.001'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_ring.01_ik.R'], '["FK_IK"]', text='Finger IK (f_ring.01.R)', slider=True)
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_finger_fk2ik_wiuwxucx1587dd46', text='FK->IK (f_ring.01.R)', icon='SNAP_ON')
            props.fk_master = 'f_ring.01_master.R'
            props.fk_chain = '["f_ring.01.R", "f_ring.02.R", "f_ring.03.R", "f_ring.01.R.001"]'
            props.ik_chain = '["ORG-f_ring.01.R", "ORG-f_ring.02.R", "ORG-f_ring.03.R"]'
            props.ik_control = 'f_ring.01_ik.R'
            props.constraint_bone = 'ORG-f_ring.03.R'
            props.axis = '+X'
            props = group1.operator('pose.rigify_finger_fk2ik_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.fk_master = 'f_ring.01_master.R'
            props.fk_chain = '["f_ring.01.R", "f_ring.02.R", "f_ring.03.R", "f_ring.01.R.001"]'
            ...
            props.axis = '+X'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_ring.01_master.R", "f_ring.01.R", "f_ring.02.R", "f_ring.03.R", "f_ring.01.R.001"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='IK->FK (f_ring.01.R)', icon='SNAP_ON')
            props.output_bones = '["f_ring.01_ik.R"]'
            props.input_bones = '["f_ring.01.R.001"]'
            props.ctrl_bones = '["f_ring.01_master.R", "f_ring.01.R", "f_ring.02.R", "f_ring.03.R", "f_ring.01.R.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.output_bones = '["f_ring.01_ik.R"]'
            ...
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_ring.01_ik.R"]'
            layout.prop(pose_bones['f_ring.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)
            if is_selected({'f_ring.01_ik.R'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'f_ring.01_ik.R'
                props.prop_bone = 'f_ring.01_ik.R'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "hand_ik.R"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['f_ring.01_ik.R'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'f_ring.01_ik.R'
                props.prop_bone = 'f_ring.01_ik.R'
                props.prop_id = 'IK_parent'
        ...
        if is_selected({'f_pinky.03.R', 'f_pinky.01_ik.R', 'f_pinky.01_master.R', 'f_pinky.02.R', 'f_pinky.01.R', 'f_pinky.01.R.001'}):
            emit_rig_separator()
            layout.prop(pose_bones['f_pinky.01_ik.R'], '["FK_IK"]', text='Finger IK (f_pinky.01.R)', slider=True)
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_finger_fk2ik_wiuwxucx1587dd46', text='FK->IK (f_pinky.01.R)', icon='SNAP_ON')
            props.fk_master = 'f_pinky.01_master.R'
            props.fk_chain = '["f_pinky.01.R", "f_pinky.02.R", "f_pinky.03.R", "f_pinky.01.R.001"]'
            props.ik_chain = '["ORG-f_pinky.01.R", "ORG-f_pinky.02.R", "ORG-f_pinky.03.R"]'
            props.ik_control = 'f_pinky.01_ik.R'
            props.constraint_bone = 'ORG-f_pinky.03.R'
            props.axis = '+X'
            props = group1.operator('pose.rigify_finger_fk2ik_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.fk_master = 'f_pinky.01_master.R'
            props.fk_chain = '["f_pinky.01.R", "f_pinky.02.R", "f_pinky.03.R", "f_pinky.01.R.001"]'
            ...
            props.axis = '+X'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_pinky.01_master.R", "f_pinky.01.R", "f_pinky.02.R", "f_pinky.03.R", "f_pinky.01.R.001"]'
            group1 = layout.row(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='IK->FK (f_pinky.01.R)', icon='SNAP_ON')
            props.output_bones = '["f_pinky.01_ik.R"]'
            props.input_bones = '["f_pinky.01.R.001"]'
            props.ctrl_bones = '["f_pinky.01_master.R", "f_pinky.01.R", "f_pinky.02.R", "f_pinky.03.R", "f_pinky.01.R.001"]'
            props.locks = (False, True, True)
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_generic_snap_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
            props.output_bones = '["f_pinky.01_ik.R"]'
            ...
            props.tooltip = 'IK to FK'
            props = group1.operator('pose.rigify_clear_keyframes_wiuwxucx1587dd46', text='', icon='CANCEL')
            props.bones = '["f_pinky.01_ik.R"]'
            layout.prop(pose_bones['f_pinky.01_master.R'], '["finger_curve"]', text='Curvature', slider=True)
            if is_selected({'f_pinky.01_ik.R'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='IK Parent', icon='DOWNARROW_HLT')
                props.bone = 'f_pinky.01_ik.R'
                props.prop_bone = 'f_pinky.01_ik.R'
                props.prop_id = 'IK_parent'
                props.parent_names = '["None", "hand_ik.R"]'
                props.locks = (False, True, True)
                group2.prop(pose_bones['f_pinky.01_ik.R'], '["IK_parent"]', text='')
                props = group1.operator('pose.rigify_switch_parent_bake_wiuwxucx1587dd46', text='', icon='ACTION_TWEAK')
                props.bone = 'f_pinky.01_ik.R'
                props.prop_bone = 'f_pinky.01_ik.R'
                props.prop_id = 'IK_parent'
        ...
        if is_selected({'hips', 'tweak_spine.005', 'spine_fk', 'tweak_spine.003', 'neck', 'tweak_spine.001', 'spine_fk.004', 'head', 'tweak_spine.004', 'spine_fk.001', 'tweak_spine.002', 'chest', 'spine_fk.002', 'torso', 'spine_fk.003', 'tweak_spine', 'tweak_spine.006'}):
            emit_rig_separator()
            ...
            if is_selected({'spine_fk.001', 'tweak_spine.002', 'chest', 'hips', 'tweak_spine.005', 'spine_fk.002', 'torso', 'spine_fk', 'spine_fk.003', 'tweak_spine', 'tweak_spine.003', 'tweak_spine.001', 'spine_fk.004', 'tweak_spine.004'}):
                group1 = layout.row(align=True)
                group2 = group1.split(factor=0.75, align=True)
                props = group2.operator('pose.rigify_switch_parent_wiuwxucx1587dd46', text='Torso Parent', icon='DOWNARROW_HLT')
                props.bone = 'torso'
        ...
        if is_selected({'thigh_tweak.L.001', 'foot_fk.L', 'toe_ik.L', 'thigh_ik_target.L', 'VIS_thigh_ik_pole.L', 'shin_fk.L', 'foot_tweak.L', 'shin_tweak.L', 'shin_tweak.L.001', 'toe_fk.L', 'thigh_ik.L', 'foot_heel_ik.L', 'foot_spin_ik.L', 'foot_ik.L', 'thigh_fk.L', 'thigh_tweak.L', 'thigh_parent.L'}):
            emit_rig_separator()
            if is_selected({'foot_fk.L', 'toe_fk.L', 'shin_fk.L', 'thigh_fk.L', 'thigh_parent.L'}):
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='FK->IK (foot.L)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_wiuwxucx1587dd46', text='IK->FK (foot.L)', icon='SNAP_ON')
            ...
            if is_selected({'foot_spin_ik.L', 'toe_ik.L', 'foot_ik.L', 'thigh_parent.L', 'thigh_ik_target.L', 'thigh_ik.L', 'foot_heel_ik.L'}):
        ...
        if is_selected({'thigh_ik_target.R', 'foot_ik.R', 'toe_ik.R', 'thigh_tweak.R', 'foot_spin_ik.R', 'thigh_ik.R', 'shin_tweak.R', 'foot_fk.R', 'thigh_fk.R', 'thigh_tweak.R.001', 'foot_tweak.R', 'shin_fk.R', 'thigh_parent.R', 'toe_fk.R', 'shin_tweak.R.001', 'foot_heel_ik.R', 'VIS_thigh_ik_pole.R'}):
            emit_rig_separator()
            if is_selected({'foot_fk.R', 'shin_fk.R', 'thigh_parent.R', 'toe_fk.R', 'thigh_fk.R'}):
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_generic_snap_wiuwxucx1587dd46', text='FK->IK (foot.R)', icon='SNAP_ON')
            ...
            group1 = layout.column(align=True)
            props = group1.operator('pose.rigify_limb_ik2fk_wiuwxucx1587dd46', text='IK->FK (foot.R)', icon='SNAP_ON')
            ...
            if is_selected({'foot_heel_ik.R', 'thigh_ik_target.R', 'foot_ik.R', 'toe_ik.R', 'thigh_parent.R', 'foot_spin_ik.R', 'thigh_ik.R'}):
...
def register():
    ...
    bpy.utils.register_class(POSE_OT_rigify_finger_fk2ik)
    bpy.utils.register_class(POSE_OT_rigify_finger_fk2ik_bake)
...
def unregister():
    ...
    bpy.utils.unregister_class(POSE_OT_rigify_finger_fk2ik)
    bpy.utils.unregister_class(POSE_OT_rigify_finger_fk2ik_bake)
